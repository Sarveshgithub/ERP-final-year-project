...
if(isset($_POST["ep"]))
	{
	 $cpass=$_POST["cpass"];
	 $q='update fac_info set pass="'.$cpass.'" where f_id="'.$tablename.'";';
	 $result = $conn->query($q);
	 if($result)
			{
...
if (isset($_POST["submit"]))
	{
		...
		if(!empty($name))
		{
			...
			$q="update fac_info set pic='upload/$name' where f_id=$tablename;";
			$result = $conn->query($q);
			if($result)
			{
...
mysql_select_db("erp");
			...
			$q1="select * from fac_info where f_id=$tablename ;";
	...
	-->
	 	   ...
	 	   <?php 
			  ...
			  ?>
		       <tr> <td>Faculty_ID:</td><td><?php echo $row[0];?></td>
               <td rowspan="4" >
               <img alt="Please upload a profile pic." style="border:5px solid #428BCA;"src="<?php echo $row[7]; ?>" height="150px;" width="150px;">
               <a data-toggle="modal" data-target="#myModal">Upload</a>  
                </td></tr>
				<tr><td>Password:</td><td><?php echo $row[1];?><a data-toggle="modal" data-target="#ep">edit</a></td></tr>
                <tr> <td>Name:</td><td><?php echo $row[2];?></td></tr>
				<tr><td>Department:</td><td><?php echo $row[3];?></td></tr>
				<tr><td>Mail-ID:</td><td><?php echo $row[4];?></td></tr>
                <tr> <td>Mobile No:</td><td><?php echo $row[5];?></td></tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="fac_pro.php" method="post" enctype="multipart/form-data" >
                <input  type="file" class="form-control" name="file" >
                <input type="submit" value="Upload"  class="form-control" name="submit">
                </form>
      </div>
...
<div id="ep" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="fac_pro.php" method="post">
