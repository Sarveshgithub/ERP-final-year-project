...
if(isset($_POST["submit"]))
	{
		  ...
		  $branch=$_POST["branch"];
			...
			$q="update student_info set  name='$name',branch='$branch',year='$year',mail='$mail'
			,mno='$mno',add='$add',dob='$dob' where rno='$rno';";
			$result = $conn->query($q);
			if($result)
			{
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Edit Student Info</h1>
    ...
    <option value="4">4th</option>
     ...
     <tr><td><label>Mobile No</label></td><td><input type="text" name="mno" class="form-control" value="<?php echo $_GET["mno"]; ?>"></td></tr>
      ...
      <textarea class="form-control" rows="3" name="add"><?php echo $_GET["add"]; ?> </textarea></td></tr>   
           ...
           <td><input type="date" class="form-control" name="dob" value="<?php echo $_GET["dob"]; ?>"></td>
           </tr>
