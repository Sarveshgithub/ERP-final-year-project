        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
           ...
           <form method="post"> 
            <tr>
           <td>
           <input type="text" required name="rno" class="form-control" placeholder="Enter the Roll Number">
           </td></tr>
           <tr>
          <td>
...
<option value="4">4th</option>
           ...
           <tr>
           <td>
           <input required type="mail" name="mail" class="form-control" placeholder="Enter the Valid Email ID">
           </td></tr>
           <tr>
           <td>
           <input required type="text" name="mno" class="form-control" placeholder="Enter 10 Digit Valid mobile number">
           </td></tr>
           <tr>
           <td>
           <textarea required rows="3" name="add" class="form-control" placeholder="Enter the Permanent Address">
           </textarea>
           </td></tr>
           <tr>
           <td>
   ...
   if(isset($_POST["bsubmit"]))
{
	...
	$q="insert into student_info values ('$rno','$pass','$name','$branch','$year','$mail','$mno','$add','$dob',' ')";
	$result = $conn->query($q);
			if($result)
			{
